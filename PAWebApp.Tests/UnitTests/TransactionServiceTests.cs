...
namespace PAWebApp.Tests.UnitTests
{
    ...
    public class TransactionServiceTests
    {
        ...
        //[Test]
        //public async Task AddAsync_ExceptionDuringProcessing_TransactionDisposedAndExceptionRethrown()
        //{
        //    // Arrange
        //    var transactionViewModel = new AddTransactionRequestModel();ansaction
        ...
        //    _transactionRepositoryMock
        //        .Setup(r => r.AddAsync(transactionModel, cancellationToken))
        ...
        //[Test]
        //public async Task AddPayment_ValidPaymentModel_CallsPaymentServiceAddAsync()
        //{
        //    // Arrange
        //    var paymentModel = new AddPaymentRequestModel();
        //    var cancellationToken = CancellationToken.None;

        //    _paymentServiceMock
        //        .Setup(p => p.AddAsync(paymentModel, cancellationToken))
        //        .Returns((Task<PaymentViewModel>)Task.CompletedTask);

        //    // Act
        //    await _transactionService.AddPayment(paymentModel, cancellationToken);

        //    // Assert
        //    _paymentServiceMock.Verify(p => p.AddAsync(paymentModel, cancellationToken), Times.Once);
        //}

        //[Test]
        //public async Task AddTransaction_ValidTransactionViewModel_CallsTransactionRepositoryAddAsync()
        //{
        //    // Arrange
        //    var transactionViewModel = new AddTransactionRequestModel();
        //    var cancellationToken = CancellationToken.None;

        //    var transactionDbModel = new Transaction();
        //    _mapperMock
        //        .Setup(m => m.Map<AddTransactionRequestModel, Transaction>(transactionViewModel))
        //        .Returns(transactionDbModel);

        //    _transactionRepositoryMock
        //        .Setup(r => r.AddAsync(transactionDbModel, cancellationToken))
        //        .ReturnsAsync(transactionDbModel);

        //    _transactionRepositoryMock
        //        .Setup(r => r.AddTransactionArticle(It.IsAny<int>(), It.IsAny<int>(), cancellationToken))
        //        .Returns(Task.CompletedTask);

        //    // Act
        //    await _transactionService.AddTransaction(transactionViewModel, cancellationToken);

        //    // Assert
        //    _transactionRepositoryMock.Verify(r => r.AddAsync(transactionDbModel, cancellationToken), Times.Once);
        //    _transactionRepositoryMock.Verify(r => r.AddTransactionArticle(It.IsAny<int>(), It.IsAny<int>(), cancellationToken), Times.Exactly(transactionViewModel.Articles.Count));
        //}
    }
}
